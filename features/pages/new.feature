...
And I create a page with "Name: main", "Menu: test"
Then a page should exist with name: "main", menu: "test", project: that project
...
When I go to that project's new page page
And I create a page with "Name: ", "Menu: test"
